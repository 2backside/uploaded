...
# Função para verificar se o Vencord já está instalado
...
# Funções de instalação (Git, Node.js, pnpm)
...
# Função para executar o comando principal baseado na opção selecionada
